...
marginaleffects::avg_predictions(mod, type = "response", variables = "Trt") 
...
marginaleffects::comparisons(mod, variables = "Trt", type = "response")
marginaleffects::avg_comparisons(mod, variables = "Trt", type = "response")
```
